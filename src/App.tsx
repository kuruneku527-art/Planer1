  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        {!isLockActive ? (
          ...
          <header
            ...
            style={{
              ...
              minHeight: 'calc(3.5rem + var(--safe-top, env(safe-area-inset-top, 0px)))',
            }}
          >
        ...
        <main
          className="flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-6 lg:p-8"
          style={{
            paddingBottom: 'calc(5rem + var(--safe-bottom, env(safe-area-inset-bottom, 0px)))',
          }}
        >
          {renderCurrentView()}
        </main>
