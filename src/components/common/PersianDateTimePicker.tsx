    ...
    <div className={`relative ${className}`} ref={containerRef} dir="rtl">
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-x-3 bottom-6 sm:bottom-auto sm:inset-x-auto sm:absolute sm:right-0 sm:mt-1.5 w-auto sm:w-80 p-3.5 rounded-2xl bg-slate-900 border border-slate-700/90 shadow-2xl shadow-purple-950/50 text-slate-100 z-50 max-w-[95vw] mx-auto animate-in fade-in sm:zoom-in-95 duration-150">
    ...
    <div className={`relative ${className}`} ref={containerRef} dir="rtl">
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-x-4 bottom-6 sm:bottom-auto sm:inset-x-auto sm:absolute sm:right-0 sm:mt-1.5 w-auto sm:w-64 p-3.5 rounded-2xl bg-slate-900 border border-slate-700/90 shadow-2xl shadow-purple-950/50 text-slate-100 z-50 max-w-[95vw] mx-auto animate-in fade-in sm:zoom-in-95 duration-150">
